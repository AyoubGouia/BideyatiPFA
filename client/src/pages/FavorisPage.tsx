      ...
      <main className={s.main}>
        <section className={s.hero}>
          ...
          <p className={s.subtitle}>
            Explorez votre collection personnelle d'établissements et de
            facultés pour votre orientation future.
          </p>
        </section>
        ...
        {loading ? (
          ...
          <div className={s.empty}>
            ...
            <p className={s.subtitle} style={{ marginBottom: "32px" }}>
              Parcourez les universités pour ajouter vos premiers favoris.
            </p>
          ...
          <div className={s.grid}>
            {favorites.map((fav) => (
              <FacultyCard
                ...
                onDetails={() =>
                  nav("faculty-detail", undefined, fav.etablissementId)
                }
              />
            ))}
          </div>
