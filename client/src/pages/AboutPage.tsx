    ...
    <div className={s.page}>
      ...
      <main className={s.main}>
        <div className={s.container}>
          <h1 className={s.title}>À propos de bideyeti</h1>

          <div className={s.section}>
            <h2 className={s.sectionTitle}>Notre mission</h2>
            <p className={s.text}>
              bideyeti est une plateforme innovante d'orientation académique
              conçue pour aider les étudiants à faire les bons choix pour leur
              avenir. Notre nom "بدايتي" signifie "mon début" en arabe,
              reflétant notre engagement à accompagner chaque étudiant au début
              ...
              <div className={s.step}>
                ...
                <div className={s.stepContent}>
                  ...
                  <p className={s.stepText}>
                    Créez votre compte et remplissez votre profil académique
                  </p>
                </div>
              </div>
              <div className={s.step}>
                ...
                <div className={s.stepContent}>
                  ...
                  <p className={s.stepText}>
                    Répondez à notre questionnaire d'orientation personnalisé
                  </p>
                </div>
              </div>
              <div className={s.step}>
                ...
                <div className={s.stepContent}>
                  ...
                  <p className={s.stepText}>
                    Découvrez les facultés qui correspondent le mieux à votre
                    profil
                  </p>
                </div>
              </div>
            ...
            <div className={s.values}>
              <div className={s.value}>
                ...
                <p className={s.valueText}>
                  Des recommandations basées sur des analyses approfondies
                </p>
              </div>
              <div className={s.value}>
                <h3 className={s.valueTitle}>🤝 Accompagnement</h3>
                <p className={s.valueText}>
                  Un soutien personnalisé à chaque étape
                </p>
              </div>
              <div className={s.value}>
